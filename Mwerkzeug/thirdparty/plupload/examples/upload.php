...
// Get parameters
$chunk = (array_get($_REQUEST,'chunk')) ? array_get($_REQUEST,'chunk') : 0;
$chunks = (array_get($_REQUEST,'chunks')) ? array_get($_REQUEST,'chunks') : 0;
$fileName = (array_get($_REQUEST,'name')) ? array_get($_REQUEST,'name') : '';

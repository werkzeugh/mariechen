...
if(jQuery) (function($) {
	...
	$.extend($.fn, {
        ...
        if(input.val()=='transparent') //mwuits
        {
          '#' + convertCase(color, o.letterCase)
          color='transparent';
          str=color;
        }
        else
        {
          str='#' + convertCase(color, o.letterCase);
        }
				...
				input
					...
					.attr('maxlength', 11)//mwuits 
					.attr('autocomplete', 'off');
        
        if(input.val()) {
  				input.val(str); //mwuits
        } 
  ...
  // ------------------- mwuits BEGIN --------------------
          if(input.val()=='t' || input.val()=='#t' || input.val()=='transparent')
          {

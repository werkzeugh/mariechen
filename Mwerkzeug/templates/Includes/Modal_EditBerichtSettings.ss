  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" ng-show="params.args.mode=='create'"><i class='fa fa-plus fa-lg'></i> neuen Bericht erstellen</h4>
      </div>
      <div class="modal-body">
        ...
        <form novalidate ng-submit="submitForm()" name="form1" class="form-horizontal">
          ...
          <div class="form-group">
            <label for="page_MenuTitle" class="col-sm-3 control-label">Bericht-Datum</label>
            <div class="col-sm-9">

<div class='MwUser MwUserNarrow' >
  ...
  <form method='POST' action='$CurrentURL' class='space bootstrap' id='dataform'>
    ...
    <div class='MwUser_resetpassword space'>
      <div class='space'>
        <div class='space'>
          <label><% _t("oldpassword","Ihr altes Passwort") %></label><input type='password' name='fdata[OldPassword]'>
        </div>
        <% _t("changePasswordText2","Geben Sie hier Bitte Hier ihr neues Passwort ein:") %>
        <div class='space'>

...
class BpMwFileController extends BackendPageController
{
  ...
  var $myClass='MwFile';
    ...
    private static $allowed_actions = [
        'iframeSave', 'iframeEdit', 'iframeReplaceFile', 'ajaxGetItemHTML', 'jsonGetInfo', 'index', 'uploadSingleFile', 'ajaxRemoveFile', 'ajaxMoveFile', 'fixParents', 'ajaxTreeRemove', 'ajaxTreeAdd', 'ajaxTreeRename', 'ajaxMoveFolder', 'receive', 'Files', 'upload', 'listing', 'folderTreeAsUL', 'UploadFile'
        ];
  ...
  static public function includeRequirementsForMwFileItem()
   {

...
use Mwerkzeug\Mwerkzeug\MwSession;
...
class MwUserController extends  FrontendPageController
{
    ...
    private static $allowed_actions= [
        ...
        'resetpassword',
        'changepassword',
        'sendPasswordLinkForUsername',
        'sendUsernameForEmail',
        'afterLogin',
        'authenticate',
        'activate',
    ...
    public function ajaxLogin()
    {
        ...
        if($_POST)
        {
            ...
            else
            {
                ...
                {
                    $autologin=$fdata['RememberMe']?1:0;
